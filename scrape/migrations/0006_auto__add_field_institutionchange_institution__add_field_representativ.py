...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstitutionChange.institution'
        db.add_column('scrape_institutionchange', 'institution', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['search.Institution']), keep_default=False)

        # Adding field 'RepresentativeChange.institution'
        db.add_column('scrape_representativechange', 'institution', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['search.Institution']), keep_default=False)

        # Adding field 'RepresentativeChange.kind'
        db.add_column('scrape_representativechange', 'kind', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['search.RepresentativeKind']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstitutionChange.institution'
        db.delete_column('scrape_institutionchange', 'institution_id')

        # Deleting field 'RepresentativeChange.institution'
        db.delete_column('scrape_representativechange', 'institution_id')

        # Deleting field 'RepresentativeChange.kind'
        db.delete_column('scrape_representativechange', 'kind_id')
