...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.is_error'
        db.add_column('mail_message', 'is_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Message.is_sent'
        db.add_column('mail_message', 'is_sent', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.is_error'
        db.delete_column('mail_message', 'is_error')

        # Deleting field 'Message.is_sent'
        db.delete_column('mail_message', 'is_sent')
    ...
    models = {
        'mail.message': {
            ...
            'reply_secret': ('django.db.models.fields.CharField', [], {'default': "'190641845'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
        ...
        'mail.unconfirmedmessage': {
            ...
            'body_text': ('django.db.models.fields.TextField', [], {}),
            'confirm_secret': ('django.db.models.fields.CharField', [], {'default': "'4152399311'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Institution']", 'null': 'True', 'blank': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'representative': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Representative']", 'null': 'True', 'blank': 'True'}),
