...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('mail_attachment', 'filename')

        # Adding field 'Attachment.file'
        db.add_column('mail_attachment', 'file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Attachment.filename'
        raise RuntimeError("Cannot reverse this migration. 'Attachment.filename' and its values cannot be restored.")

        # Deleting field 'Attachment.file'
        db.delete_column('mail_attachment', 'file')
    ...
    models = {
        ...
        'mail.message': {
            ...
            'reply_secret': ('django.db.models.fields.CharField', [], {'default': "'4572609300'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
        ...
        'mail.unconfirmedmessage': {
            ...
            'body_text': ('django.db.models.fields.TextField', [], {}),
            'confirm_secret': ('django.db.models.fields.CharField', [], {'default': "'3589190036'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Institution']", 'null': 'True', 'blank': 'True'}),
            'representative': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Representative']", 'null': 'True', 'blank': 'True'}),
