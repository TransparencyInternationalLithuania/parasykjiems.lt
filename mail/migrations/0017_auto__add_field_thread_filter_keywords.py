...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.filter_keywords'
        db.add_column('mail_thread', 'filter_keywords', self.gf('django.db.models.fields.TextField')(default='', db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.filter_keywords'
        db.delete_column('mail_thread', 'filter_keywords')
    ...
    models = {
        'mail.message': {
            ...
            'reply_secret': ('django.db.models.fields.CharField', [], {'default': "'1445205602'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
        ...
        'mail.unconfirmedmessage': {
            ...
            'body_text': ('django.db.models.fields.TextField', [], {}),
            'confirm_secret': ('django.db.models.fields.CharField', [], {'default': "'5942916812'", 'max_length': '10', 'db_index': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institution': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Institution']", 'null': 'True', 'blank': 'True'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'representative': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['search.Representative']", 'null': 'True', 'blank': 'True'}),
