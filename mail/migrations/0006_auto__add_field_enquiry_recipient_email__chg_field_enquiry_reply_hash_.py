...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enquiry.recipient_email'
        db.add_column('mail_enquiry', 'recipient_email', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Enquiry.recipient_email'
        db.delete_column('mail_enquiry', 'recipient_email')

        # Changing field 'Enquiry.reply_hash'
        db.alter_column('mail_enquiry', 'reply_hash', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Enquiry.confirm_hash'
        db.alter_column('mail_enquiry', 'confirm_hash', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        'mail.enquiry': {
            ...
            'confirm_hash': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'reply_hash': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
