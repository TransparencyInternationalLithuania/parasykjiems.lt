...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mail_enquiry', 'reply_hash', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Enquiry.confirm_hash'
        db.alter_column('mail_enquiry', 'confirm_hash', self.gf('django.db.models.fields.BigIntegerField')())
    ...
    models = {
        'mail.enquiry': {
            ...
            'confirm_hash': ('django.db.models.fields.BigIntegerField', [], {'default': '6959282987', 'db_index': 'True', 'blank': 'True'}),
            ...
            'reply_hash': ('django.db.models.fields.BigIntegerField', [], {'default': '2355464200', 'db_index': 'True', 'blank': 'True'}),
