...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enquiry.recipient_name'
        db.add_column('mail_enquiry', 'recipient_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Enquiry.recipient_name'
        db.delete_column('mail_enquiry', 'recipient_name')
