...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Enquiry', fields ['reply_hash']
        db.delete_unique('mail_enquiry', ['reply_hash'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Enquiry', fields ['reply_hash']
        db.create_unique('mail_enquiry', ['reply_hash'])
    ...
    models = {
        'mail.enquiry': {
            ...
            'reply_hash': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
