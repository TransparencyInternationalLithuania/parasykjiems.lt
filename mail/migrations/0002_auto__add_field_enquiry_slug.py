...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Enquiry.slug'
        db.add_column('mail_enquiry', 'slug', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Enquiry.slug'
        db.delete_column('mail_enquiry', 'slug')
