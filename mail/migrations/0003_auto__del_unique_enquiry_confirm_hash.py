...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Enquiry', fields ['confirm_hash']
        db.delete_unique('mail_enquiry', ['confirm_hash'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Enquiry', fields ['confirm_hash']
        db.create_unique('mail_enquiry', ['confirm_hash'])
