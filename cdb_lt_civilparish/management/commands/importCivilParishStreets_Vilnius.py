...
class Command(BaseCommand):
    ...
    def extractStreetsAndHouseNumbers(self, fileName):
    ...
    def handle(self, *args, **options):
        ...
        zipped = zip(civilParishFiles, civilParishNames)
        ...
        for file, civilParish in zipped:
            ...
            for street, houseNumber in self.extractStreetsAndHouseNumbers(file):
            ...
            self.insertAll(streetMap, civilParish= civilParish)
