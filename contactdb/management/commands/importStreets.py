...
from pjutils.uniconsole import UniStream
import os
...
importStreets 5:8 - will import streets for counties from 5 to 8 county inclusive  """
    ...
    def handle(self, *args, **options):
        ...
        for count, pollingDistrict in allPollingDistricts.iteritems():
            ...
            print (u"%d: saved County '%s %d', \nElectoral District '%s' streets (%d). \nTotal streets so far %d" % (count, pollingDistrict.County.name, pollingDistrict.County.nr, pollingDistrict.ElectionDistrict, numberOfStreets, totalNumberOfStreets))
