...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstitutionKind.ordinal'
        db.add_column('search_institutionkind', 'ordinal', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstitutionKind.ordinal'
        db.delete_column('search_institutionkind', 'ordinal')
