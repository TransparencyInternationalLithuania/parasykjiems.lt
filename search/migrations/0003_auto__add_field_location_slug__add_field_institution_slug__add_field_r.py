...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('search_location', 'slug', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Institution.slug'
        db.add_column('search_institution', 'slug', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Representative.slug'
        db.add_column('search_representative', 'slug', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.slug'
        db.delete_column('search_location', 'slug')

        # Deleting field 'Institution.slug'
        db.delete_column('search_institution', 'slug')

        # Deleting field 'Representative.slug'
        db.delete_column('search_representative', 'slug')
