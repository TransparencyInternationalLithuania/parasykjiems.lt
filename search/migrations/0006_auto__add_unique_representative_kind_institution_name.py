...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Representative', fields ['kind', 'institution', 'name']
        db.create_unique('search_representative', ['kind_id', 'institution_id', 'name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Representative', fields ['kind', 'institution', 'name']
        db.delete_unique('search_representative', ['kind_id', 'institution_id', 'name'])
