...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InstitutionKind.active'
        db.delete_column('search_institutionkind', 'active')

        # Deleting field 'RepresentativeKind.active'
        db.delete_column('search_representativekind', 'active')


    def backwards(self, orm):
        
        # Adding field 'InstitutionKind.active'
        db.add_column('search_institutionkind', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'RepresentativeKind.active'
        db.add_column('search_representativekind', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
