...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'InstitutionKind', fields ['name']
        db.create_unique('search_institutionkind', ['name'])

        # Adding unique constraint on 'RepresentativeKind', fields ['name']
        db.create_unique('search_representativekind', ['name'])

        # Adding unique constraint on 'Territory', fields ['elderate', 'street', 'municipality', 'institution', 'city']
        db.create_unique('search_territory', ['elderate', 'street', 'municipality', 'institution_id', 'city'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Territory', fields ['elderate', 'street', 'municipality', 'institution', 'city']
        db.delete_unique('search_territory', ['elderate', 'street', 'municipality', 'institution_id', 'city'])

        # Removing unique constraint on 'RepresentativeKind', fields ['name']
        db.delete_unique('search_representativekind', ['name'])

        # Removing unique constraint on 'InstitutionKind', fields ['name']
        db.delete_unique('search_institutionkind', ['name'])
